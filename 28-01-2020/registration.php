            ...
            <div id="div1">
                ...
                <fieldset>
                    ...
                    <div id="firstname">
                        ...
                        : <input type="text" name="account[fname]" value="<?php echo output('account', 'fname'); ?>">
                    </div>
                    <br>
                    <div id="lastname">
                        <label>2. Last Name </label>
                        : <input type="text" name="account[lname]" value="<?php echo output('account', 'lname'); ?>">
                    </div>
                    <br>
                    <div id="dob">
                        <label>3. Date Of Birth </label>
                        : <input type="date" name="account[dob]" value="<?php echo output('account', 'dob'); ?>">
                    </div>
                    <br>
                    <div id="pnumber">
                    ...
                    <div id="confirmPassword">
                        ...
                        :<input type="password" name="account[confirmPassword]" value="<?php echo output('account', 'confirmPassword'); ?>">
                    </div>
                    <br>
                </fieldset>
            ...
            <div id="div2">
                <fieldset>
                    ...
                    <div id="address1">
                        ...
                        : <input type="text" name="address[addr1]" value="<?php echo output('address', 'addr1'); ?>">
                    </div>
                    <br>
                    <div id="addr2">
                        <label>2. Address Line 2</label>
                        : <input type="text" name="address[addr2]" value="<?php echo output('address', 'addr2'); ?>">
                    </div>
                    <br>
                    <div id="company">
                    ...
                    <div id="postcode">
                        ...
                        <input type="number" name="address[pincode]" value="<?php echo output('address', 'pincode'); ?>">
                    </div>
                    <br>
            ...
            <div id="div3" style="display: none">
                <fieldset>
                    ...
                    <div id="about">
                        ...
                        : <textarea name="other[about]" rows="6" cols="30"><?php echo output('other', 'about'); ?></textarea>
                    </div>
                    <br>
                    <div id="profile">
                    ...
                    <div id="business_time">
                        ...
                        foreach ($radio as $rvalue) : ?>
                            ...
                            <input type="radio" name="other[radio]" value="<?php echo $rvalue; ?>" <?php echo $radio_val_1; ?>> <?php echo $rvalue; ?>
                        <?php endforeach ?>
                    </div>
                    <br>
                    <div id="clients">
                    ...
                    <div id="touch">
                        ...
                        foreach ($touch as $how_touch) : ?>
                            ...
                            <input type="checkbox" name="other[chkbox][]" value="<?php echo $how_touch; ?>" <?php echo $checked_val_1 ?>>
                            <?php echo $how_touch; ?>
                        <?php endforeach; ?>
